...
const NextMeetingFollowUps = ({ isDarkMode = false }) => {
  ...
  // Load today's meeting leads (check for scheduled meetings today)
  useEffect(() => {
    const loadTodaysMeetingLeads = async () => {
      try {
        setLoading(true);
  ...
  const handleRefresh = async () => {
    try {
      ...
      console.error('Failed to refresh today\'s meeting leads:', err);
    } finally {
              ...
              {loading ? (
                <tr>
                  <td colSpan="8" className={`px-4 py-8 text-center ${
                    ...
                    <div className="flex items-center justify-center space-x-2">
                      ...
                      <span>Loading today's scheduled meetings...</span>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td colSpan="8" className={`px-4 py-8 text-center ${
                    ...
                    No meetings scheduled for today. Try adjusting your search or filters.
                  </td>
                </tr>
              ) : (
