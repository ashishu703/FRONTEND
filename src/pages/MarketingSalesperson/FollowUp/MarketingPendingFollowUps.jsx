...
const MarketingPendingFollowUps = () => {
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading marketing pending leads...</p>
        </div>
      </div>
    );
  }

  return <MarketingFollowUpBase status="pending" customData={pendingData} />;
};

export default MarketingPendingFollowUps;
